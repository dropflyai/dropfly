...
const screenshots = [
  ...
  {
    name: 'mission-cutscene',
    url: 'http://localhost:3002/mission/variable-village/week-4/lesson-1',
    path: 'public/screenshots/codefly/mission-cutscene.png',
    description: 'Mission Cutscene/Lesson'
  },
  {
...
async function captureScreenshots() {
  console.log('🎬 Capturing CodeFly CORRECTED screenshots...\n');
