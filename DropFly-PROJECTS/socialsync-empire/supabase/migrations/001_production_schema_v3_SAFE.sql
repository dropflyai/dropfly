-- Production Database Schema Migration for SocialSync (Safe Version)
...
CREATE TABLE IF NOT EXISTS public.users (
  ...
  subscription_tier TEXT DEFAULT 'free' CHECK (subscription_tier IN ('free', 'starter', 'creator', 'pro', 'agency', 'enterprise')),
...
-- Usage tracking table - DROP AND RECREATE to fix schema issues
